...
//@Configuration 
@EnableWebSecurity// теперь настройки конфигурации бери отсюда
...
public class AuthorizationConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.sessionManagement()
			.sessionCreationPolicy(SessionCreationPolicy.STATELESS);//turn of cookies 
		// every time you need authorization // we can save it not in cookies
